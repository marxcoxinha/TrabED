...
int main() { 
	...
	pegar.Primeiro->item.objeto.imagem = al_load_bitmap("..\\imagens\\itens\\boombox.png");
	pegar.Primeiro->prox->item.objeto.imagem = al_load_bitmap("..\\imagens\\itens\\presente1.png");
	carregaEarl(&p);
